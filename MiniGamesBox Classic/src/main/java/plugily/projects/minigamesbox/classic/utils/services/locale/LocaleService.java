...
public class LocaleService {
  ...
  private void loadPluginLocales() {
    if(localeData == null || !localeData.isSet("locales.register")) {
      return;
    }

    if(localeData.getConfigurationSection("locales.register") == null) {
      return;
    }
