...
public class StatisticType implements IStatisticType {
  ...
  static {
    ...
    statistics.put("LEVEL", new StatisticType("level", true, "bigint(20) NOT NULL DEFAULT '0'", true));
    statistics.put("EXP", new StatisticType("exp", true, "bigint(20) NOT NULL DEFAULT '0'", true));
    statistics.put("NEXT_LEVEL_EXP", new StatisticType("next_level_exp", true, "bigint(20) NOT NULL DEFAULT '0'", true));
  }
